public class Ghost2 { 
	...
	public static void move() {
		int choice2 = (int) (Math.random()*4);

		if ( (choice2 == 0) && Scene.canMove(x,y-1)){
				y--;
			}
			else if ((choice2 == 1) && Scene.canMove(x,y+1)) {
				y++;
			}
			else if ((choice2 == 2) && Scene.canMove(x-1,y)) {
				x--;
			}
			else if ((choice2 == 3) && Scene.canMove(x+1,y)) {
				x++;
			}
		time = System.currentTimeMillis();						
		}
